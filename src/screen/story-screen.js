...
class IntroScreen extends StoryScreen {
    constructor() {
        ...
        (async () => {
            ...
            await this.finalize(nomangle('为你的主人复仇'));
        })();
    }
    ...
    render() {
        ...
        ctx.wrap(() => {
            ...
            ctx.drawCommandText(nomangle('[回车]跳过'));
        });
    }
}
...
class RevengeScreen extends StoryScreen {
    constructor() {
        ...
        (async () => {
            ...
            const label = this.world.addEntity(new Label(nomangle('完成你的复仇')));
            label.x = CELL_SIZE * 6;
            label.y = CELL_SIZE / 2;
            label.z = 99;
